  ...
  return (<>
    {selectedUser ? (
      <div className="user-page">
        <h2 className='user-name'><b>{selectedUser.name}</b></h2>
        <h5><b>Email:</b> {selectedUser.email}</h5>
        <h5><b>Sex:</b> {selectedUser.sex[0].toUpperCase() + selectedUser.sex.slice(1)}</h5>
        <h5><b>Профессия:</b> {selectedUser.profession.name}</h5>
        ...
        <h5><b>Completed Meetings:</b> {selectedUser.completedMeetings}</h5>
        <h5><b>Rate:</b> {selectedUser.rate}</h5>
        <h5><b>Bookmark:</b> {selectedUser.bookmark ? (
          <i
            style={{ fontSize: '20px' }}
